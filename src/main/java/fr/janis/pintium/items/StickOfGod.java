...
public class StickOfGod extends Item {
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
        ...
        if (!playerIn.getCooldownTracker().hasCooldown(this)) {
            playerIn.addPotionEffect(new EffectInstance(Effects.ABSORPTION, 20 * 180, 4));
            playerIn.addPotionEffect(new EffectInstance(Effects.REGENERATION, 20 * 3, 0));
            playerIn.addPotionEffect(new EffectInstance(Effects.SATURATION, 20 * 10, 1));
            playerIn.addPotionEffect(new EffectInstance(Effects.SPEED, 20 * 180, 1));
            ...
            playerIn.getCooldownTracker().setCooldown(this, 20*300);

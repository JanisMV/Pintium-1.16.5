...
public class SaveFormat {
   ...
   private static <T> Pair<DimensionGeneratorSettings, Lifecycle> func_237259_a_(Dynamic<T> p_237259_0_, DataFixer p_237259_1_, int p_237259_2_) {
      ...
      Dynamic<T> dynamic1 = net.minecraftforge.common.ForgeHooks.fixUpDimensionsData(p_237259_1_.update(TypeReferences.field_233375_y_, dynamic, p_237259_2_, SharedConstants.getVersion().getWorldVersion()));

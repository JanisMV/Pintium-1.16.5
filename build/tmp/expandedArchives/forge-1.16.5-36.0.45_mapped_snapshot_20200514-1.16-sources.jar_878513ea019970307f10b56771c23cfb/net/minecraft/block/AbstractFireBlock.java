   ...
   private static boolean func_241466_b_(World p_241466_0_, BlockPos p_241466_1_, Direction p_241466_2_) {
      if (!func_242649_a(p_241466_0_)) {
         ...
         if (!flag) {
            ...
            Direction.Axis direction$axis = p_241466_2_.getAxis().isHorizontal() ? p_241466_2_.rotateYCCW().getAxis() : Direction.Plane.HORIZONTAL.func_244803_b(p_241466_0_.rand);

...
public class IngameGui extends AbstractGui {
   ...
   public UUID func_244795_b(ITextComponent p_244795_1_) {
      ...
      return s1 == null ? Util.field_240973_b_ : this.mc.func_244599_aA().func_244797_a(s1);
   }

   public void func_238450_a_(ChatType p_238450_1_, ITextComponent p_238450_2_, UUID p_238450_3_) {
      if (!this.mc.func_238198_a_(p_238450_3_)) {
         if (!this.mc.gameSettings.field_244794_ae || !this.mc.func_238198_a_(this.func_244795_b(p_238450_2_))) {

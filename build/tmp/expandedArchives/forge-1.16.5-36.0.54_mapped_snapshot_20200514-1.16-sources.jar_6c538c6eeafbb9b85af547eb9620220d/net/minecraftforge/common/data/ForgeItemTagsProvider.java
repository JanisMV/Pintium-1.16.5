...
public class ForgeItemTagsProvider extends ItemTagsProvider
{
    ...
    {
        func_240522_a_(Tags.Items.BONES).func_240532_a_(Items.BONE);
        func_240522_a_(Tags.Items.BOOKSHELVES).func_240532_a_(Items.BOOKSHELF);
        ...
        func_240522_a_(Tags.Items.CROPS_BEETROOT).func_240532_a_(Items.BEETROOT);
        func_240522_a_(Tags.Items.CROPS_CARROT).func_240532_a_(Items.CARROT);
        func_240522_a_(Tags.Items.CROPS_NETHER_WART).func_240532_a_(Items.NETHER_WART);
        func_240522_a_(Tags.Items.CROPS_POTATO).func_240532_a_(Items.POTATO);
        func_240522_a_(Tags.Items.CROPS_WHEAT).func_240532_a_(Items.WHEAT);
        func_240522_a_(Tags.Items.DUSTS).addTags(Tags.Items.DUSTS_GLOWSTONE, Tags.Items.DUSTS_PRISMARINE, Tags.Items.DUSTS_REDSTONE);
        func_240522_a_(Tags.Items.DUSTS_GLOWSTONE).func_240532_a_(Items.GLOWSTONE_DUST);
        func_240522_a_(Tags.Items.DUSTS_PRISMARINE).func_240532_a_(Items.PRISMARINE_SHARD);
        func_240522_a_(Tags.Items.DUSTS_REDSTONE).func_240532_a_(Items.REDSTONE);
        addColored(func_240522_a_(Tags.Items.DYES)::addTags, Tags.Items.DYES, "{color}_dye");
        func_240522_a_(Tags.Items.EGGS).func_240532_a_(Items.EGG);
        func_240521_a_(Tags.Blocks.END_STONES, Tags.Items.END_STONES);
        func_240522_a_(Tags.Items.ENDER_PEARLS).func_240532_a_(Items.ENDER_PEARL);
        func_240522_a_(Tags.Items.FEATHERS).func_240532_a_(Items.FEATHER);
        ...
        func_240522_a_(Tags.Items.GEMS_DIAMOND).func_240532_a_(Items.DIAMOND);
        func_240522_a_(Tags.Items.GEMS_EMERALD).func_240532_a_(Items.EMERALD);
        func_240522_a_(Tags.Items.GEMS_LAPIS).func_240532_a_(Items.LAPIS_LAZULI);
        func_240522_a_(Tags.Items.GEMS_PRISMARINE).func_240532_a_(Items.PRISMARINE_CRYSTALS);
        func_240522_a_(Tags.Items.GEMS_QUARTZ).func_240532_a_(Items.QUARTZ);
        ...
        func_240522_a_(Tags.Items.GUNPOWDER).func_240532_a_(Items.GUNPOWDER);
        ...
        func_240522_a_(Tags.Items.INGOTS_BRICK).func_240532_a_(Items.BRICK);
        func_240522_a_(Tags.Items.INGOTS_GOLD).func_240532_a_(Items.GOLD_INGOT);
        func_240522_a_(Tags.Items.INGOTS_IRON).func_240532_a_(Items.IRON_INGOT);
        func_240522_a_(Tags.Items.INGOTS_NETHERITE).func_240532_a_(Items.field_234759_km_);
        func_240522_a_(Tags.Items.INGOTS_NETHER_BRICK).func_240532_a_(Items.NETHER_BRICK);
        func_240522_a_(Tags.Items.LEATHER).func_240532_a_(Items.LEATHER);
        func_240522_a_(Tags.Items.MUSHROOMS).func_240534_a_(Items.BROWN_MUSHROOM, Items.RED_MUSHROOM);
        func_240522_a_(Tags.Items.NETHER_STARS).func_240532_a_(Items.NETHER_STAR);
        ...
        func_240522_a_(Tags.Items.NUGGETS_IRON).func_240532_a_(Items.IRON_NUGGET);
        func_240522_a_(Tags.Items.NUGGETS_GOLD).func_240532_a_(Items.GOLD_NUGGET);
        ...
        func_240522_a_(Tags.Items.RODS_BLAZE).func_240532_a_(Items.BLAZE_ROD);
        func_240522_a_(Tags.Items.RODS_WOODEN).func_240532_a_(Items.STICK);
        ...
        func_240522_a_(Tags.Items.SEEDS_BEETROOT).func_240532_a_(Items.BEETROOT_SEEDS);
        func_240522_a_(Tags.Items.SEEDS_MELON).func_240532_a_(Items.MELON_SEEDS);
        func_240522_a_(Tags.Items.SEEDS_PUMPKIN).func_240532_a_(Items.PUMPKIN_SEEDS);
        func_240522_a_(Tags.Items.SEEDS_WHEAT).func_240532_a_(Items.WHEAT_SEEDS);
        func_240522_a_(Tags.Items.SHEARS).func_240532_a_(Items.SHEARS);
        func_240522_a_(Tags.Items.SLIMEBALLS).func_240532_a_(Items.SLIME_BALL);
        ...
        func_240522_a_(Tags.Items.STRING).func_240532_a_(Items.STRING);
    }
